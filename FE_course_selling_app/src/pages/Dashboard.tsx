...
export default function Dashboard() {
  ...
  const handlePurchaseCourse = async (courseId: string) => {
    try {
      ...
      if (response.ok) {
        toast.success("Course purchased successfully!", { position: 'top-right', autoClose: 2000 });
        ...
        toast.error("Failed to purchase course", { position: 'top-right', autoClose: 3000 });
      }
    } catch (error) {
  ...
  const handleUpdateCourse = async (courseId: string, updatedData: Partial<Course>) => {
    try {
      ...
      if (response.ok) {
        toast.success("Course updated successfully!", { position: 'top-right', autoClose: 2000 });
      ...
      toast.error("Failed to update course", { position: 'top-right', autoClose: 3000 });
    }
  };
