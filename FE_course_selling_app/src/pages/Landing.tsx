...
export default function Landing() {
  return (
    <div className="bg-white">
      <ToastContainer />
      {/* Hero Section */}
      <div className="relative bg-gradient-to-r from-indigo-600 to-indigo-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="mt-3 max-w-md mx-auto text-base text-indigo-100 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
              Access high-quality courses taught by industry experts. Start learning today and take your skills to the next level.
            </p>
            <div className="mt-5 max-w-md mx-auto sm:flex sm:justify-center md:mt-8">
              <div className="rounded-md shadow">
                <Link
                  to="/user/signup"
                  onClick={() => toast.info("Redirecting to signup...", { position: 'top-right', autoClose: 2000 })}
              ...
              <div className="pt-6">
                <div className="flow-root bg-white rounded-lg px-6 pb-8">
                  <div className="-mt-6">
                    ...
                    <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">Expert-led courses</h3>
